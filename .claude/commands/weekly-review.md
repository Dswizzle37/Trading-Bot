---
description: Friday weekly review workflow (local, uses .env)
---
...
STEP 4 — Append full review section to memory/WEEKLY-REVIEW.md: stats table, closed trades table, open positions at week end, 3-5 "what worked" bullets, 3-5 "what didn't work" bullets, key lessons, adjustments for next week, overall letter grade A-F.
